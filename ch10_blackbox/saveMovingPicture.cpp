...
int main() {
    ...
    CvCapture *capture = cvCaptureFromAVI("/home/russel90/blackbox/su.avi");
    ...
    writer = cvCreateVideoWriter("/home/russel90/blackbox/copy.avi", CV_FOURCC('D', 'I', 'V', 'X'), fps, cvGetSize(frame));
    while (1) {
